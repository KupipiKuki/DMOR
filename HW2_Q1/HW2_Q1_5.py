...
def f2(x):
    return 200-0.5*x
def fo(x,z):
    return (z-26500*x)/17667
def limits(x1,y1):
    a=solve([3*x+2*y<=600,0.5*x+y<=200,x>=0,y<=x,y>=0], x)
...
plt.annotate('26500*x1+17667*x2=5300000',(70,200),color='red')
plt.annotate('3*x1+2*x2<=600',(40,250),color='black')
plt.annotate('0.5*x1+x2<=200',(275,75),color='black')

plt.xlim(0,400)
plt.ylim(0,300)
plt.title('ESI 6314 HW2 Q.1.5')
